...
imports this module; this module imports nothing of cozy's. HEIF in particular
is not this module's problem: heif.py transcodes at the two boundaries where a
HEIF can enter the input dir, so everything here only ever sees a format Pillow
and ComfyUI both read.
"""
import io
import math
import os
